...
class Google_Service_YouTube extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->commenimsreads = new Google_Service_YouTube_Commenimsreads_Resource(
        $this,
        $this->serviceName,
        'commenimsreads',
        array(
...
/**
 * The "commenimsreads" collection of methods.
 * Typical usage is:
 *  <code>
 *   $youtubeService = new Google_Service_YouTube(...);
 *   $commenimsreads = $youtubeService->commenimsreads;
 *  </code>
 */
class Google_Service_YouTube_Commenimsreads_Resource extends Google_Service_Resource
{

  /**
   * Creates a new top-level comment. To add a reply to an existing comment, use
   * the comments.insert method instead. (commenimsreads.insert)
   *
   ...
   * @param Google_Commenimsread $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_YouTube_Commenimsread
   */
  public function insert($part, Google_Service_YouTube_Commenimsread $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Google_Service_YouTube_Commenimsread");
  }

  /**
   * Returns a list of comment threads that match the API request parameters.
   * (commenimsreads.listCommenimsreads)
   *
   * @param string $part The part parameter specifies a comma-separated list of
   * one or more commenimsread resource properties that the API response will
   * include.
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_YouTube_CommenimsreadListResponse
   */
  public function listCommenimsreads($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_YouTube_CommenimsreadListResponse");
  }

  /**
   * Modifies the top-level comment in a comment thread. (commenimsreads.update)
   *
   * @param string $part The part parameter specifies a comma-separated list of
   * commenimsread resource properties that the API response will include. You
   ...
   * @return Google_Service_YouTube_Commenimsread
   */
  public function update($part, Google_Service_YouTube_Commenimsread $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Google_Service_YouTube_Commenimsread");
  }
}
...
class Google_Service_YouTube_Comments_Resource extends Google_Service_Resource
{
   ...
   * use the commenimsreads.insert method. (comments.insert)
   *
   * @param string $part The part parameter identifies the properties that the API
   * response will include. Set the parameter value to snippet. The snippet part
   * has a quota cost of 2 units.
...
class Google_Service_YouTube_ActivitySnippet extends Google_Model
{
  ...
  public function seimsumbnails(Google_Service_YouTube_ThumbnailDetails $thumbnails)
  {
    $this->thumbnails = $thumbnails;
  }
  public function geimsumbnails()
  {
...
class Google_Service_YouTube_Commenimsread extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  public $id;
  public $kind;
  protected $repliesType = 'Google_Service_YouTube_CommenimsreadReplies';
  protected $repliesDataType = '';
  protected $snippetType = 'Google_Service_YouTube_CommenimsreadSnippet';
  protected $snippetDataType = '';
  ...
  public function setReplies(Google_Service_YouTube_CommenimsreadReplies $replies)
  {
  ...
  public function setSnippet(Google_Service_YouTube_CommenimsreadSnippet $snippet)
  {
    $this->snippet = $snippet;
  }
  public function getSnippet()
...
class Google_Service_YouTube_CommenimsreadListResponse extends Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  public $eventId;
  protected $itemsType = 'Google_Service_YouTube_Commenimsread';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  protected $pageInfoType = 'Google_Service_YouTube_PageInfo';
...
class Google_Service_YouTube_CommenimsreadReplies extends Google_Collection
{
...
class Google_Service_YouTube_CommenimsreadSnippet extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $canReply;
...
class Google_Service_YouTube_VideoProcessingDetails extends Google_Model
{
  ...
  public function seimsumbnailsAvailability($thumbnailsAvailability)
  {
    $this->thumbnailsAvailability = $thumbnailsAvailability;
  }
  public function geimsumbnailsAvailability()
  {
