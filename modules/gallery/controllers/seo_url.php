...
$ims->conf['cur_act'] = (isset($ims->conf['cur_act'])) ? $ims->conf['cur_act'] : "gallery";
...
function load_setting ()
{
    ...
    $ims->load_data->data_group('gallery');
    return $ims->setting;
}
load_setting ();
