...
class UploadHandler {
    ...
    protected $allow_nosignin = false;
    protected $nosignin_dir = 'user/public';
    protected $options;
...
//        echo $this->get_full_url() . '/' . basename($this->get_server_var('SCRIPT_NAME'));
//        echo '<br />' . dirname($this->get_server_var('SCRIPT_FILENAME')) . '/files/';
//        die;

        if($this->allow_nosignin == true && $ims->site_func->checkUserLogin() != 1) {
            $folder_conf = $this->nosignin_dir;
        } else {
        ...
        $this->options = array(
            ...
            'script_url' => $ims->site_func->get_link_ajax('global'),
            'upload_dir' => $ims->conf['rootpath'].'uploads/'.$folder_conf,
            'upload_url' => $ims->conf['rooturl'].'uploads/'.$folder_conf,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    ...
                    'upload_dir' => $ims->conf['rootpath'].'thumbs/'.$folder_conf,
                    'upload_url' => $ims->conf['rooturl'].'thumbs/'.$folder_conf,
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
        ...
        $name = $ims->func->fix_file_name ($name);
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        ...
        $file->name = $ims->func->fix_file_name ($file->name);
