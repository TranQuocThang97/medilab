                ...
                var webFontConfig = {
                    loading: function () {
                        if (AV.controlsWidgetInstance) {
                            AV.controlsWidgetInstance.showWaiimsrobber(true)
                        }
                    },
                    active: function () {
                        if (AV.controlsWidgetInstance) {
                            AV.controlsWidgetInstance.showWaiimsrobber(false)
                        }
                        if (callback) {
                            callback(font)
                        }
...
(function (exports, window, document) {
    ...
    AV.ToolManager = function (controls) {
        ...
        var panelSwitcher = function (mode) {
            ...
            _setPanelMode(mode);
            AV.controlsWidgetInstance.onEggWaiimsrobber.stop();
        ...
        var openToolByName = function (toolName, eggElement) {
            ...
            if (_toolExists(toolName) || AV.launchData.forceCropPreset) {
                if (controls.paintWidget && !controls.paintWidget.moduleLoaded(toolName, panelSwitcher)) {
                    if (eggElement) {
                        controls.onEggWaiimsrobber.stop();
                        controls.onEggWaiimsrobber.spin(avpw$(eggElement).children(".avpw_icon_waiter")[0])
                    }
                }
            }
...
(function (exports, window, document) {
    ...
    AV.paintWidgetLauncher_Flash_stage2 = function (imageWidth, imageHeight) {
        ...
        AV.controlsWidgetInstance.showWaiimsrobber(false);
        avpw$(AV.controlsWidgetInstance.onEggWaiimsrobber).hide();
    ...
    AV.mockLauncher = function (imgElement) {
        ...
        AV.util.nextFrame(function () {
            ...
            AV.controlsWidgetInstance.initWithPaintWidget = function (paintWidget) {
                ...
                this.initAllTools();
                this.bindControls();
                this.paintWidget.showWaiimsrobber = this.showWaiimsrobber.AV_bindInst(this)
            };
            AV.controlsWidgetInstance.loaderPhase = 1;
    ...
    AV.ControlsWidget = function (paintWidget, paintImgIdElem, activeTools, assetManager, serverMessaging) {
        ...
        this.waiimsrobber = new AV.Spinner(canvasThrobberConfig);
        this.onEggWaiimsrobber = new AV.Spinner(eggThrobberConfig);
    ...
    AV.ControlsWidget.prototype.shutdown = function () {
        ...
        if (this.paintWidget) {
            this.paintWidget.showWaiimsrobber = null
        }
        AV.usageTracker.shutdown();
        this.waiimsrobber.stop();
        this.onEggWaiimsrobber.stop();
        this.waiimsrobber = null;
        this.onEggWaiimsrobber = null;
        this.showPanel(null);
    ...
    AV.ControlsWidget.prototype.showWaiimsrobber = function (show, callback) {
        var fadeTime = 300;
        var _this = this;
        if (show) {
            var embedElement = this.layoutNotify(AV.launchData["openType"], "getEmbedElement");
            if (embedElement.is(":visible")) {
                this.waiimsrobber.spin(embedElement[0]);
                avpw$(this.waiimsrobber).fadeIn(fadeTime)
            }
        } else {
            avpw$(_this.waiimsrobber.el).fadeOut(fadeTime, _this.waiimsrobber.stop)
        } if (callback) {
    ...
    AV.ControlsWidget.prototype.save = function () {
        ...
        var saveCallbackWithURL = function (url, url_hires, error) {
            ...
            cw.paintWidget.showWaiimsrobber(false);
            if (url) {
        ...
        var saveViaHTML = function (type, callback, showConfirmation, mime) {
            ...
            this.paintWidget.showWaiimsrobber(showThrobber, function () {
                switch (type) {
                case "saveHiRes":
...
(function (exports, window, document) {
    ...
    AV.Feather = function (config) {
        ...
        api.showWaitIndicator = function () {
            if (AV.controlsWidgetInstance && AV.controlsWidgetInstance.showWaiimsrobber) {
                AV.controlsWidgetInstance.showWaiimsrobber(true);
                return true
            } else {
                return false
