...
function apply_img_muti(file,external){
    ...
    if (external!=""){
			...
			$(target).append('<div class="pic-item"><a class="fancybox-effects-a" href="'+base_url+path+file+'"><img src="'+base_url+path+file+'" alt="'+file+'" /></a><a href="javascript:;" class="btn-remove"><i class="ficon-cancel"></i></a><input name="arr_picture[]" value="'+base_url+path+file+'" type="hidden" /></div>');
