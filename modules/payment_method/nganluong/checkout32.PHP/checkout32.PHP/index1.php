...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="vi" xml:lang="vi">
    ...
    if (@$_POST['nlpayment']) {
        ...
        $tax_amount = 0;
        $fee_shipping = 0;
        $return_url = 'http://localhost/nganluong/demo/checkout32/payment_success.php';
        ...
        <form  name="NLpayBank" action="#" method="post">	
            <table style="clear:both;width:500px;padding-left:46px;"> 
                ...
                <tr><td>Card Number: </td>
                    <td>
                        <input type="text" style="width:270px" id="card_number" name="card_number" class="field-check " value="<?= @$_REQUEST['card_number'] ?>">
                    </td>
                </tr>
                <tr><td>Card fullname: </td>
                    <td>
                        <input type="text" style="width:270px" id="card_fullname" name="card_fullname" class="field-check " value="<?= @$_REQUEST['card_fullname'] ?>">
                    </td>
                </tr>
                <tr><td>Card Month: </td>
                    <td>
                        <input type="text" style="width:270px" id="card_month" name="card_month" class="field-check " value="<?= @$_REQUEST['card_month'] ?>">
                    </td>
                </tr>
                <tr><td>Card Year: </td>
                    <td>
                        <input type="text" style="width:270px" id="card_year" name="card_year" class="field-check " value="<?= @$_REQUEST['card_year'] ?>">
                    </td>
                </tr>
            </table>	
