...
<div class="cart_content"> 
    <div id="form_cart">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped cart_table" width="100%" border="0" cellpadding="8" cellspacing="1">
                <tr>
    ...
    <script language="javascript">imsOrdering.cart_del_item();</script>
    <div class="clear"></div>  
</div>
<!-- END: table_cart --> 
...
<div class="ordering_address">
    <div class="ordering_address_o">
        <h3>{LANG.product.ordering_address}</h3>   
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.full_name}</label>
                    <input name="o_full_name" type="text" maxlength="100" value="{data.o_full_name}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.email}</label>
                    <input name="o_email" type="text" maxlength="100" value="{data.o_email}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.phone}</label>
                    <input name="o_phone" type="text" maxlength="100" value="{data.o_phone}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.address}</label>
                    <input name="o_address" type="text" maxlength="100" value="{data.o_address}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
    ...
    <div class="ordering_address_d">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.full_name}</label>
                    <input name="d_full_name" type="text" maxlength="100" value="{data.d_full_name}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.email}</label>
                    <input name="d_email" type="text" maxlength="100" value="{data.d_email}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.phone}</label>
                    <input name="d_phone" type="text" maxlength="100" value="{data.d_phone}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="title">{LANG.product.address}</label>
                    <input name="d_address" type="text" maxlength="100" value="{data.d_address}" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
    ...
    <script language="javascript">
        imsLocation.listProvince_load_child();
        imsLocation.list_location_district_load_child();
        imsOrdering.same_address();
        $().ready(function () {
            ...
            $("#form_ordering_address").validate({
                ...
                messages: {
                    ...
                    o_email: "{LANG.global.err_invalid_emai  l}",
                    ...
                    d_email: "{LANG.global.err_invalid_emai  l}",
    ...
    <div id="ordering_method_input">
        <div class="ordering_method">
            <div class="request_more">
                ...
                <div><textarea name="request_more" class="form-control" rows="5" >{data.request_more}</textarea></div>
                <div class="clear"></div>
            </div> 
